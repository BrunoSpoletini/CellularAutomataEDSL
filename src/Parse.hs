...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseStmt","%start_parseStmts","Coms","Com","DefCell","NList","Position","lineno","'='","'('","')'","','","'['","']'","NVAR","DEFCELL","INT","STEP","CHECK","UPDATE","%eof"]
        bit_start = st * 23
        bit_end = (st + 1) * 23
